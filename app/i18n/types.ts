...
export type LangCode = 'en' | 'nb' | 'de' | 'ru' | 'pl' | 'ar' | 'fr' | 'es' | 'tr' | 'ja' | 'ko' | 'vi' | 'uk' | 'it' | 'pt' | 'id'

export const SUPPORTED_LANGS: LangCode[] = ['en', 'nb', 'de', 'ru', 'pl', 'ar', 'fr', 'es', 'tr', 'ja', 'ko', 'vi', 'uk', 'it', 'pt', 'id']
